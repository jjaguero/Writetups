# ChocolateLovers - Writeup (DockerLabs)
...
Descripción: Laboratorio para practicar la explotación del CMS Nibbleblog para obtener una shell y escalar privilegios en Linux.

**Herramientas usadas:** `nmap`, `whatweb`, `gobuster`, navegador (panel admin Nibbleblog), Netcat, [revshells.com](https://www.revshells.com/), GTFOBins.

![Banner](./images/Pasted%20image%2020260714203808.png)
...
![Código fuente de la página por defecto de Apache](./images/Pasted%20image%2020260714191503.png)

Mostrando su contenido:

![Contenido de la URL encontrada](./images/Pasted%20image%2020260714191550.png)
...
![Enlace al panel de Nibbleblog](./images/Pasted%20image%2020260714191656.png)
...
![Acceso al panel de administración](./images/Pasted%20image%2020260714191836.png)
...
![Plugin de subida de imágenes](./images/Pasted%20image%2020260714193313.png)

Al entrar en "Configure" aparece un formulario para subir un archivo:

![Formulario de subida de archivo](./images/Pasted%20image%2020260714193619.png)
...
![Resultado del fuzzing con gobuster](./images/Pasted%20image%2020260714192502.png)

Revisando las rutas encontradas se ubica la ruta exacta donde quedan almacenadas las imágenes subidas:

![Ruta exacta de las imágenes subidas](./images/Pasted%20image%2020260714193902.png)
...
![Subida del archivo shell.php](./images/Pasted%20image%2020260714194248.png)
...
![Confirmación de subida correcta](./images/Pasted%20image%2020260714194457.png)

Al acceder directamente al archivo se comprueba el bypass: se ejecuta PHP en el servidor y se obtiene el usuario `www-data`:

![Ejecución de PHP confirmando el bypass](./images/Pasted%20image%2020260714194916.png)
...
![Subida de la reverse shell](./images/Pasted%20image%2020260714195751.png)
...
![Verificación de permisos sudo](./images/Pasted%20image%2020260714200342.png)
...
![Proceso ejecutado por root cada 5 segundos](./images/Pasted%20image%2020260714201354.png)
...
![Permisos de escritura en /opt/script.php](./images/Pasted%20image%2020260714201630.png)
...
![Binario rootbash con SUID en /tmp](./images/Pasted%20image%2020260714202131.png)
